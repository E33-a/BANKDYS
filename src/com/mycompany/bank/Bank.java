...
public class Bank {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            do {       
                ...
                switch (opc) {
                    case 1 -> opBank(colect); // Operaciones del banco
                    case 2 -> opCustomer(); // Operaciones de usuarios
                }
     ...
     */
    static public void opBank(ColectCust colect) {
