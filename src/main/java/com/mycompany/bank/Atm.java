...
public class Atm implements InterfaceOperations{
    ...
    public static void loginCust(Card card) {
        String nameCom;
        String nip;
        int cont;
    ...
    public static void withdrawMoney(Customer cus) {
        ...
        do {
            ...
            else if(getMoneyT() < mWithdraw){
                JOptionPane.showMessageDialog(null, "El cajero no tiene esa cantidad\nIntenta nuevamente");
            }
        } while (mWithdraw < 50 || mWithdraw > 15000 || (mWithdraw > getMoneyT()));

        double atmres = getMoneyT();
